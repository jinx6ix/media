  ...
  return (
    <div className="p-6 max-w-lg">
      <div className="mb-6">
        ...
        <p className="text-sm text-[#5a4a2a] mt-1">
          Organise photos into a collection
        </p>
      </div>
      ...
      <form onSubmit={handleCreate} className="space-y-5">
        ...
        <div className="flex items-center gap-3 p-4 bg-[#161616] border border-[#2a2010] rounded-lg">
          ...
          <div>
            <p className="text-sm text-[#a09070] font-medium">
              {isPublic ? "Public album" : "Private album"}
            </p>
            <p className="text-xs text-[#5a4a2a] mt-0.5">
              {isPublic
                ? "Anyone with the share link can view — no login needed"
                : "Only signed-in team members can view"}
            </p>
          </div>
        </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            className="bg-[#c9a84c] hover:bg-[#e0bc60] disabled:opacity-40 disabled:cursor-not-allowed text-[#0d0d0d] font-medium rounded-lg px-5 py-2.5 text-sm transition-colors flex items-center gap-2"
          >
            {loading ? (
              <>
          ...
          <button
            type="button"
            onClick={() => router.back()}
            className="border border-[#2a2010] text-[#a09070] hover:text-[#c9a84c] hover:border-[#c9a84c40] rounded-lg px-5 py-2.5 text-sm transition-colors"
          >
            Cancel
          </button>
        </div>
